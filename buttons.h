...
#define BUTTON0_PUSHED 1
#define BUTTON1_PUSHED 2
#define BUTTON2_PUSHED 4
#define BUTTON3_PUSHED 8

#define NUM_BUTTONS 4

// How long until we register a held button
#define INITIAL_HOLD 500
// How long until we reread a held button
#define HOLD_ACTION_DELAY 100
